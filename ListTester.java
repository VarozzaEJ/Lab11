...
public class ListTester {
	 ...
	 */
	private IndexedUnsortedList<Integer> AB_iterNextAddC_ACB() {
        IndexedUnsortedList<Integer> list = A_addToRearB_AB();
    ...
    private Scenario<Integer> AB_iterNextAddC_ACB = () -> AB_iterNextAddC_ACB();
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
        ...
        try {
            ...
            printTest(scenarioName + "_testIndexOfA", testIndexOf(scenario.build(), contents[0], 0));
            printTest(scenarioName + "_testIndexOfB", testIndexOf(scenario.build(), contents[1], 1));
            printTest(scenarioName + "_testIndexOfC", testIndexOf(scenario.build(), contents[2], 2));
            printTest(scenarioName + "_testIndexOfX", testIndexOf(scenario.build(), ELEMENT_X, -1));
            printTest(scenarioName + "_testFirst", testFirst(scenario.build(), contents[0], Result.MatchingValue));
            ...
            // Iterator
            // test for construct iterator
            printTest(scenarioName + "_testIter", testIter(scenario.build(), Result.NoException));
            // tests after reaching iterator
            printTest(scenarioName + "_testIterHasNext", testIterHasNext(WrapIt.prep(scenario.build()).getIterator(), Result.True));
            printTest(scenarioName + "_testIterNext", testIterNext(WrapIt.prep(scenario.build()).getIterator(), contents[0], Result.MatchingValue));
            printTest(scenarioName + "_testIterRemove", testIterRemove(WrapIt.prep(scenario.build()).getIterator(), Result.IllegalState));
            // tests after calling next on the iterator
            printTest(scenarioName + "_iterNext_testIterHasNext", testIterHasNext(WrapIt.prep(scenario.build()).next().getIterator(), Result.True));
            printTest(scenarioName + "_iterNext_testIterNext", testIterNext(WrapIt.prep(scenario.build()).next().getIterator(), contents[1], Result.MatchingValue));
            printTest(scenarioName + "_iterNext_testIterRemove", testIterRemove(WrapIt.prep(scenario.build()).next().getIterator(), Result.NoException));
            // tests after calling next, then next, on the iterator
            ...
            // tests after calling next, then next, and then next, on the iterator
            printTest(scenarioName + "_iterNextNext_testIterHasNext", testIterHasNext(WrapIt.prep(scenario.build()).next().next().next().getIterator(), Result.False));
            printTest(scenarioName + "_iterNextNext_testIterNext", testIterNext(WrapIt.prep(scenario.build()).next().next().next().getIterator(), null, Result.NoSuchElement));
            printTest(scenarioName + "_iterNextNext_testIterRemove", testIterRemove(WrapIt.prep(scenario.build()).next().next().next().getIterator(), Result.NoException));
            // ListIterator
            if (SUPPORTS_LIST_ITERATOR) {
                printTest(scenarioName + "_testListIter", testListIter(scenario.build(), Result.NoException));
                printTest(scenarioName + "_testListIterNextIndex", testListIterNextIndex(WrapIt.prep(scenario.build(), true).getListIterator(), 0, Result.MatchingValue));
                ...
                printTest(scenarioName + "_testListIter2Previous", testListIterPrevious(WrapIt.prep(scenario.build(), 2).getListIterator(), contents[1], Result.MatchingValue)); //should return C
                printTest(scenarioName + "_testListIter3Previous", testListIterPrevious(WrapIt.prep(scenario.build(), 3).getListIterator(), contents[2], Result.MatchingValue)); //should return B
                ...
                printTest(scenarioName + "_testListIter1Next", testListIterNext(WrapIt.prep(scenario.build(), 1).getListIterator(), contents[1], Result.MatchingValue)); // should return C
                printTest(scenarioName + "_testListIter2Next", testListIterNext(WrapIt.prep(scenario.build(), 2).getListIterator(), contents[2], Result.MatchingValue)); //should return B
